...
<html>
	<head>
		...
		<link rel="stylesheet" href="resource/js/highlight/styles/default.css">
        ...
        <script type="text/javascript" src="resource/js/highlight/highlight.pack.js"></script>
				...
				<?php
						if (isset($_GET['mode']) && $_GET['mode']=='view_article' && isset($_GET['article']))
						{
							...
							if (!$result = $connection->query($sql)) {
								...
								echo "<div class='article'>".$article['content']."</div>";
							}
						}
