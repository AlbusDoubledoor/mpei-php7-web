<?php
	...
	function store_article() {
		...
		if ($_POST['mode'] == "create")
			$sql = "INSERT INTO articles VALUES (NULL,'".$_POST['container_id']."','".$_POST['article_title']."','".$_POST['content']."',NULL,NULL,NULL,NULL)";
		if ($_POST['mode'] == "refresh")
			$sql = "UPDATE articles SET article_title='".$_POST['article_title']."',container_id='".$_POST['container_id']."',article_sort_order='".$_POST['sort_order']."',content='".$_POST['content']."' WHERE article_id='".$_POST['article_id']."'";
	...
	function store_board() {
		...
		if ($_POST['mode'] == "create")
			$sql = "INSERT INTO board VALUES (NULL,'".$_POST['board_title']."','".$_POST['content']."','".$_POST['date']."',NULL)";
		if ($_POST['mode'] == "refresh")
			$sql = "UPDATE board SET board_title='".$_POST['board_title']."',date='".$_POST['date']."',board_sort_order='".$_POST['sort_order']."',content='".$_POST['content']."' WHERE board_id='".$_POST['board_id']."'";
